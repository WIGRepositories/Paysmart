...
namespace Paysmart.Controllers
{
    public class WalletTransDetailsController : ApiController
    {
        ...
        [HttpGet]
        [Route("api/WalletTransDetails/DriverGetWalletTransDetails")]
        public DataTable DriverGetWalletTransDetails(string MobileNo)
        {
            DataTable Tbl = new DataTable();
            StringBuilder str = new StringBuilder();
            LogTraceWriter traceWriter = new LogTraceWriter();
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "DriverEWGetTransDetails";
                cmd.Parameters.Add("@MobileNo", SqlDbType.VarChar).Value = MobileNo;
                cmd.Connection = conn;
        ...
        [HttpPost]
        [Route("api/WalletTransDetails/DriversavewalletTransdetails")]
