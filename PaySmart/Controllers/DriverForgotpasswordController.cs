...
{
    public class DriverForgotpasswordController : ApiController
    {
        [HttpPost]
        [Route("api/DriverForgotpassword/Forgotpassword")]
...
<div style='padding:10px;border:#0000FF solid 2px;'>    <br /><br />
        ...
        [HttpPost]
        [Route("api/DriverForgotpassword/BusinessAppForgotpassword")]
        public DataTable BusinessAppForgotpassword(DriverAccount ocr)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "PSBusinessAppForgotPassword";
