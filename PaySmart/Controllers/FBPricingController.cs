...
{
    public class FBPricingController : ApiController
    {
        [HttpGet]
        [Route("api/FBPricing/getFBPricing")]
        public DataTable getFBPricing()
        {
        ...
        [HttpPost]
        [Route("api/FBPricing/saveFBPricing")]
        public DataTable saveFBPricing(fbpricing n)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                tracer.Trace(Request, "0", System.Web.Http.Tracing.TraceLevel.Info, "{0}", "FBPricing....");
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "InsUpdDelFBPricing";
                cmd.Connection = conn;
                ...
                SqlParameter dee = new SqlParameter("@airlineid", SqlDbType.VarChar, 500);
                ...
                SqlParameter lal = new SqlParameter("@taxes", SqlDbType.Decimal);
                lal.Value = n.taxes;
                ...
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                da.Fill(dt);
               tracer.Trace(Request, "0", System.Web.Http.Tracing.TraceLevel.Info, "{0}", "FBPricing closed....");
